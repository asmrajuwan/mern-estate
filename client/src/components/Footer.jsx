    ...
    <footer className="bg-[#7dd3fc] text-slate-700 p-4 sm:p-8">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between mb-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <Link to="/contact" className="text-ellipsis text-xl font-bold text-slate-500 hover:text-slate-700">
            Contact
          </Link>
          <Link to="/about" className="text-ellipsis text-xl font-bold text-slate-500 hover:text-slate-700">
            About
          </Link>
          <Link to="/privacy" className="text-ellipsis text-xl font-bold text-slate-500 hover:text-slate-700">
            Privacy
          </Link>
        </div>
      </div>
      <div className="text-center pb-4 sm:pb-8">
        ...
        <p className="text-sm">Email: info@dreamnestcom</p>
        <p className="text-ellipsis mt-4">
          &copy; {new Date().getFullYear()} Dream Nest. All rights reserved.
        </p>
      </div>
    </footer>
  );
